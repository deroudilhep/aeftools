...
recommended <- c("#e4032d", "#fe7f2d", "#fcca46", "#579c87", "#0e3d59", "#59536d")
gradients <- list(
...
extended <- c("#e4032d", "#ff5e5e", "#ff9d92", "#bf777f", "#794d52", "#492228", "#a93900", "#fe7f2d", "#fcca46", "#9cb557", "#579c87", "#0b7879", "#0e3d59", "#6186a6", "#a8cdf0", "#59536d", "#9174a2", "#ff88b3", "#ab3b69", "#650030")
